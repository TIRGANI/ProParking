                ...
                <div class="col-md-6 grid-margin stretch-card">
                  <div class="card">
                    <div class="card-body d-flex flex-column justify-content-between"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                      ...
                      <h4>1352</h4>
                      <canvas id="transactions-chart" class="mt-auto chartjs-render-monitor" style="display: block; height: 65px; width: 168px;" width="252" height="97"></canvas>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 grid-margin stretch-card">
                  <div class="card">
                    <div class="card-body d-flex flex-column justify-content-between"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                      ...
                      <canvas id="sales-chart-a" class="mt-auto chartjs-render-monitor" style="display: block; height: 65px; width: 168px;" width="252" height="97"></canvas>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="col-md-6 stretch-card grid-margin grid-margin-md-0">
                  <div class="card">
                    <div class="card-body d-flex flex-column justify-content-between"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                      ...
                      <canvas id="sales-chart-b" class="mt-auto chartjs-render-monitor" style="display: block; height: 38px; width: 168px;" width="252" height="57"></canvas>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="card-body">
                      <div class="row h-100">
                        <div class="col-6 d-flex flex-column justify-content-between"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                          ...
                          <h4>55%</h4>
                          <canvas id="cpu-chart" class="mt-auto chartjs-render-monitor" style="display: block; height: 36px; width: 72px;" width="108" height="54"></canvas>
                        </div>
                        <div class="col-6 d-flex flex-column justify-content-between"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                          <p class="text-muted">Memory</p>
                          <h4>123,65</h4>
                          <canvas id="memory-chart" class="mt-auto chartjs-render-monitor" style="display: block; height: 36px; width: 72px;" width="108" height="54"></canvas>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-md-12 stretch-card">
                  <div class="card">
                    <div class="card-body"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                      ...
                      <canvas id="income-chart" style="display: block; height: 208px; width: 416px;" class="chartjs-render-monitor" width="624" height="312"></canvas>
                    </div>
                  </div>
                </div>
              </div>
